  ...
  <div class="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
    <form @submit.prevent="addCategorie">
      ...
      <div class="mb-3">
        ...
        <input type="texte" class="form-control" id="imagecategorie" v-model="categorie.imagecategorie">
      </div>
...
const addCategorie = async () => {
  await axios.post("/api/categories/", categorie.value)
    .then(() => (
      router.push({ name: 'viewCategory' }))).catch(err => console.log(err))
